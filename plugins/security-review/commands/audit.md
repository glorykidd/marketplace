...
argument-hint: "[target-path] [--focus <area>] [--severity <level>]"
---

# Security Review

Perform a comprehensive security audit of a codebase against industry standards (OWASP Top 10, CWE, NIST 800-53, CIS Benchmarks, SOC 2, ISO 27001). Produces a terminal summary and a detailed markdown report.

## Usage

```
/security-review:audit [target-path] [--focus <area>] [--severity <level>]
```
